...
Complete Crosswind motion syntax reference — keyframe timelines, timing controls, staggered text, 3D transforms, filter animations, and all animatable properties.
