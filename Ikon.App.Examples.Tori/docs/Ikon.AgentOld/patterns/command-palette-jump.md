...
- Filter scoring is simple substring match here. For larger palettes, score title prefix matches higher (see `fuzzy-search-list`).
...
- `fuzzy-search-list` — better scoring for >100 items
