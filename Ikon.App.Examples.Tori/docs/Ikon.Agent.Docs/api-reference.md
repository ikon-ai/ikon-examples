...
namespace Ikon.Connectors
  ...
  sealed record GitHubCommentRequest
    ctor(string Repo, int Number, string Body)
    string Body { get; init; }
    int Number { get; init; }
    string Repo { get; init; }
  sealed record GitHubCreateIssueRequest
    ctor(string Repo, string Title, string Body)
    string Body { get; init; }
    string Repo { get; init; }
    string Title { get; init; }
  ...
  sealed record GitHubIssueRequest
    ctor(string Repo, int Number)
    int Number { get; init; }
    string Repo { get; init; }
  sealed record GitHubMergeRequest
    ctor(string Repo, int Number, string? CommitTitle = null)
    string? CommitTitle { get; init; }
    int Number { get; init; }
    string Repo { get; init; }
