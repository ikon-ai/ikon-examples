// <auto-generated />
// Build config for the boot-snapshot prerender bundle, which renders captured route snapshots to
// static HTML at `ikon app bundle` time (SEO + instant first paint). Run via
// `npm run build:prerender`.
//
// To prerender custom UI modules, create src/prerender-modules.ts exporting
